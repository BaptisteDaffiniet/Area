...
import '../Wigets/Youtube_Widget.dart';
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: FutureBuilder<bool>(
        future: get_youtube_subscriptions(),
...
String google_url = 'http://10.0.2.2:8080/api/is_user_registered_youtube';

Future<bool>get_youtube_subscriptions() async
{
